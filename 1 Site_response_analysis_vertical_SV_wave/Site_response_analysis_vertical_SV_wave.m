...
Vs_ER = 200; rho_ER = 2000; damper_c_ER = rho_ER * Vs_ER;
...
%--------------------------------------------------------------------------
[EssentialBCX,EssentialBCY,NodeXYCoordinate, ElementConnectivity] = fun_MeshInfo_Soil_Column;
...
t1 = 2;dt = 0.001;t = (0:dt:t1)';n = length(t);
...
disp('done with newmark integration')
%--------------------------------------------------------------------------
% writting information needed for implementing the DRM
%--------------------------------------------------------------------------
save DRM_response_Homo.mat u_history udot_history uddot_history

...
%
% DRM_response_Homo.mat contains 3 matrices:
%   1) u_history       :displacement
%   2) udot_history    :velocity
%   3) uddot_history   :acceleration
...
% load the mesh info for the soil column (in fact only the depth info is
%   useful)
[~,~,NodeXYSoilColl_SC, ~] = fun_MeshInfo_Soil_Column;
